 ...
 * Time: 2019/6/8
 */
public class MidAdapter extends BaseAdapter implements PinnedSectionListView.PinnedSectionListAdapter {
    ...
    public MidAdapter(Context context, ArrayList<MidBean> list, HashMap<String, Integer> map_IsHead) {
        this.list = list;
